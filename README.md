...
Tokens are used for passing identity of authenticated users like login credentials.

- [ ] What steps can you take in your web apps to keep your data secure?

Use HTTPS and protected routes.

- [ ] Describe how web servers work.

Web servers are contacted through a URL and domain name, and serves data/code to users that request it.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

The PUT method can be mapped to the U for UPDATE in the CRUD acronym.
